                ...
                <form action="konfirmasi_kontak.php" method="get" >
                    ...
                    <div class="row mb-3">
                        <div class="col p-0">
                            ...
                            <input type="checkbox" id="jajan" name="hobi" value="jajan">
                            <label for="jajan">jajan</label><br>
                            <input type="checkbox" id="volly" name="hobi" value="voly">
                            <label for="volly">volly</label><br>
                        </div>
                    </div>
                    <!-- END FORM HOBI -->
